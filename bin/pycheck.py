...
<!-- saved from url=(0103)http://pychecker.cvs.sourceforge.net/viewvc/pychecker/pychecker/pycheckrc?revision=1.52&pathrev=current -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;"># Sample defaults file for PyChecker 0.8.17
